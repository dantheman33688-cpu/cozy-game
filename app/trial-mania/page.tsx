...
import TrialManiaContent from "@/components/content/TrialManiaContent";
...
export const metadata: Metadata = {
  title: `Trial Mania: Ultimate 3D Off-Road Racing and Stunt Mastery Guide | ${siteConfig.domain}`,
  description:
    "Master extreme off-road racing and stunt techniques in Trial Mania! Learn bike customization, track strategies, and physics-based riding. Complete guide inside!",
  alternates: { canonical: "https://www.cozygame.net/trial-mania" },
  openGraph: {
    title: "Trial Mania Strategy Guide: Master 3D Off-Road Racing and Extreme Stunts",
    description:
      "Conquer challenging off-road tracks and master extreme stunts in Trial Mania. Learn bike physics, customization, and advanced racing techniques.",
    url: "https://www.cozygame.net/trial-mania",
    siteName: "Duck Duck Click",
    images: [
      {
        url: "/assets/trial-mania/trial-mania-logo.webp",
        width: 1200,
        height: 630,
        alt: "Trial Mania Strategy Guide: 3D Off-Road Racing and Stunt Mastery",
      },
    ],
    locale: "en_US",
    type: "website",
  ...
  twitter: {
    ...
    title: "Trial Mania: Ultimate Off-Road Racing and Stunt Challenge Guide",
    description:
      "Master physics-based motorcycle racing and extreme stunts in Trial Mania. Complete bike customization and track strategy guide.",
    images: ["/assets/trial-mania/trial-mania-logo.webp"],
  },
  robots: {
    index: true,
    follow: true,
...
const gameConfig: GameConfig = {
  metadata: {
    title: "Trial Mania: Ultimate 3D Off-Road Racing and Stunt Challenge Guide",
    description:
      "Master extreme off-road racing, bike physics, and stunt techniques in Trial Mania. Complete strategy guide for bike customization and track mastery.",
    url: "/trial-mania",
  },
  content: {
    header: {
    ...
    footer: {
      about: {
        title: "About",
        description: `Play Trial Mania - an intense 3D off-road racing game that combines realistic physics with extreme stunt challenges. Master bike handling, customize your ride, and conquer challenging tracks across five diverse worlds. No downloads required - play directly in your browser!`,
      },
      quickLinks: {
        title: "Quick Links",
      ...
      games: {
        ...
        links: [
          ...
          { text: "Trial Mania", href: "/trial-mania" },
    ...
    gameSection: {
      title: "Trial Mania",
      game: {
        url: "/game/trial-mania/index.html",
        title: "Trial Mania",
        externalUrl: "https://st.8games.net/11/igra-trial-maniya/",
      },
    },
    otherGames: {
      title: "Other Games",
...
export default function TrialManiaPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
      ...
      <div className="max-w-6xl mx-auto px-4 pb-8">
        <TrialManiaContent content={articleContent} />
      </div>
      ...
      <div className="video-wrapper my-8 text-center">
        <iframe
          width="560"
          height="315"
          src="https://www.youtube.com/embed/CnKuqpL-zOc?si=mnCj-uKYfxfrfL6r" 
          title="Trial Mania Walkthrough Gameplay"
          frameBorder="0"
        ...
        <p className="text-sm text-gray-500 mt-2">
          <strong>Trial Mania</strong> Walkthrough Gameplay
        </p>
      </div>
      ...
      <div className="flex justify-center mt-6 mb-10 gap-4">
        <a
          href="https://play.google.com/store/apps/details?id=com.aceviral.bikemania2&hl=en_GB"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center bg-gradient-to-r from-green-600 to-yellow-500 text-white rounded-xl px-5 py-2 hover:from-green-700 hover:to-yellow-600 transition-colors"
        >
          <svg
        ...
        <a
          href="https://g.igroutka.ru/games/571/wy2RbCQn89GmPJHo/c7df93cd-236a-4b4f-a872-25ed17ad0d6d/index.html"
          target="_blank"
          rel="noopener noreferrer"
