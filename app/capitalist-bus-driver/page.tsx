...
import CapitalistBusDriverContent from "@/components/content/CapitalistBusDriverContent";
...
export const metadata: Metadata = {
  title: `Capitalist Bus Driver: From Wheel to Empire Strategy Guide | ${siteConfig.domain}`,
  description:
    "Master the dual business empire in Capitalist Bus Driver. Learn how to balance bus operations and resort development for maximum profits in this comprehensive strategy guide!",
  alternates: { canonical: "https://www.cozygame.net/capitalist-bus-driver" },
  openGraph: {
    title: "Capitalist Bus Driver: From Wheel to Empire Strategy Guide",
    description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Capitalist Bus Driver Strategy Guide",
      },
    ],
    locale: "en_US",
    type: "website",
  ...
  twitter: {
    ...
    title: "Capitalist Bus Driver: From Wheel to Empire Strategy Guide",
    description:
      "Master the dual business empire in Capitalist Bus Driver. Balance bus operations and resort development for maximum profits.",
    images: ["/assets/capitalist-bus-driver/capitalist-bus-driver-logo.webp"],
  },
  robots: {
    index: true,
    follow: true,
...
const gameConfig: GameConfig = {
  ...
  content: {
    ...
    footer: {
      about: {
        title: "About",
        description: `Play Capitalist Bus Driver - a unique simulation game that combines relaxing driving with deep tycoon strategy. Build your bus and resort empire right in your browser. No downloads required.`,
      },
      quickLinks: {
        title: "Quick Links",
      ...
      games: {
        ...
        links: [
          ...
          { text: "Capitalist Bus Driver", href: "/capitalist-bus-driver" },
    ...
    rating: {
      title: "Rate Capitalist Bus Driver!",
      votes: "votes",
      initialRating: 0,
      initialVotes: 0,
    },
    gameSection: {
      title: "Capitalist Bus Driver",
      game: {
        url: "/game/capitalist-bus-driver/index.html",
        title: "Capitalist Bus Driver",
        externalUrl:
          "https://gamesforboys.net/wp-content/uploads/2025/game/capitalist-bus-driver.html",
      },
    },
    otherGames: {
      title: "Other Games",
    ...
    whatIs: {
      title: "What is Capitalist Bus Driver?",
      description: "",
      logo: { src: "", alt: "" },
    },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
      ...
      <div className="max-w-6xl mx-auto px-4 pb-8">
        <CapitalistBusDriverContent content={articleContent} />
      </div>

      {/* 🚀 App Store 下载按钮 */}
      <div className="flex justify-center mt-6 mb-10">
        <a
          href="https://apps.apple.com/gb/app/capitalist-bus-driver/id6752121016"
          target="_blank"
