// components/content/IdleLumberIncContent.tsx
'use client';
...
interface IdleLumberIncContentProps {
  content: {
    title: string;
    sections: any[];
  };
...
export default function IdleLumberIncContent({ content }: IdleLumberIncContentProps) {
