// components/content/OrbitBeatsContent.tsx
'use client';

import React from 'react';
import Image from 'next/image';

interface OrbitBeatsContentProps {
  content: {
    title: string;
    sections: any[];
  };
...
export default function OrbitBeatsContent({ content }: OrbitBeatsContentProps) {
  ...
  const renderSection = (section: any) => {
    ...
    if (section.type === 'conclusion') {
      return (
        <div
          id={section.id}
          className="bg-gradient-to-r from-purple-50 to-blue-50 rounded-lg shadow-md p-6 mb-6 border-l-4 border-purple-500 scroll-mt-20"
        >
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto px-4 max-w-4xl">
        {/* 顶部标题区块 - 使用紫色到蓝色的渐变（音乐节奏主题） */}
        <div className="bg-gradient-to-r from-purple-600 to-blue-500 text-white rounded-lg shadow-lg p-8 mb-8">
