// components/content/DriftbossContent.tsx
'use client';

import React from 'react';
import Image from 'next/image';

interface DriftbossContentProps {
  content: {
    title: string;
    sections: any[];
  };
...
export default function DriftbossContent({ content }: DriftbossContentProps) {
  ...
  const renderSection = (section: any) => {
    ...
    if (section.type === 'conclusion') {
      return (
        <div
          id={section.id}
          className="bg-gradient-to-r from-orange-50 to-purple-50 rounded-lg shadow-md p-6 mb-6 border-l-4 border-orange-500 scroll-mt-20"
        >
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto px-4 max-w-4xl">
        {/* 顶部标题区块 - 使用橙色到紫色的渐变 */}
        <div className="bg-gradient-to-r from-orange-500 to-purple-600 text-white rounded-lg shadow-lg p-8 mb-8">
