// components/content/TowerMergeContent.tsx
'use client';

import React from 'react';
import Image from 'next/image';

interface TowerMergeContentProps {
  content: {
    title: string;
    sections: any[];
  };
...
export default function TowerMergeContent({ content }: TowerMergeContentProps) {
  ...
  const renderSection = (section: any) => {
    ...
    if (section.type === 'conclusion') {
      return (
        <div
          id={section.id}
          className="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-lg shadow-md p-6 mb-6 border-l-4 border-purple-500 scroll-mt-20"
        >
