// components/content/RocketFortressContent.tsx
'use client';

import React from 'react';
import Image from 'next/image';

interface RocketFortressContentProps {
  content: {
    title: string;
    sections: any[];
  };
...
export default function RocketFortressContent({ content }: RocketFortressContentProps) {
  ...
  const renderSection = (section: any) => {
    ...
    if (section.type === 'conclusion') {
      return (
        <div
          id={section.id}
          className="bg-gradient-to-r from-orange-50 to-red-50 rounded-lg shadow-md p-6 mb-6 border-l-4 border-orange-500 scroll-mt-20"
        >
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto px-4 max-w-4xl">
        {/* 顶部标题区块 - 使用橙色到红色的渐变（火箭/火焰主题） */}
        <div className="bg-gradient-to-r from-orange-500 to-red-600 text-white rounded-lg shadow-lg p-8 mb-8">
