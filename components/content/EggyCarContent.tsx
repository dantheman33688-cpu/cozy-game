// components/content/EggyCarContent.tsx
'use client';

import React from 'react';
import Image from 'next/image';

interface EggyCarContentProps {
  content: {
    title: string;
    sections: any[];
  };
...
export default function EggyCarContent({ content }: EggyCarContentProps) {
  ...
  const renderSection = (section: any) => {
    ...
    if (section.type === 'conclusion') {
      return (
        <div
          id={section.id}
          className="bg-gradient-to-r from-yellow-50 to-orange-50 rounded-lg shadow-md p-6 mb-6 border-l-4 border-yellow-500 scroll-mt-20"
        >
