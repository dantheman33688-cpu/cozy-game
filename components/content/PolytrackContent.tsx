// components/content/PolytrackContent.tsx
'use client';

import React from 'react';
import Image from 'next/image';

interface PolytrackContentProps {
  content: {
    title: string;
    sections: any[];
  };
...
export default function PolytrackContent({ content }: PolytrackContentProps) {
  ...
  const renderSection = (section: any) => {
    ...
    if (section.type === 'conclusion') {
      return (
        <div
          id={section.id}
          className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-lg shadow-md p-6 mb-6 border-l-4 border-blue-500 scroll-mt-20"
        >
