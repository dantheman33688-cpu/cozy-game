// components/content/TrialManiaContent.tsx
'use client';

import React from 'react';
import Image from 'next/image';

interface TrialManiaContentProps {
  content: {
    title: string;
    sections: any[];
  };
...
export default function TrialManiaContent({ content }: TrialManiaContentProps) {
  ...
  const renderSection = (section: any) => {
    ...
    if (section.type === 'conclusion') {
      return (
        <div
          id={section.id}
          className="bg-gradient-to-r from-green-50 to-yellow-50 rounded-lg shadow-md p-6 mb-6 border-l-4 border-green-500 scroll-mt-20"
        >
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto px-4 max-w-4xl">
        {/* 顶部标题区块 - 使用绿色到黄色的渐变（越野摩托主题） */}
        <div className="bg-gradient-to-r from-green-600 to-yellow-500 text-white rounded-lg shadow-lg p-8 mb-8">
